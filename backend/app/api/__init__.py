...
# 导入所有端点路由
from app.api.endpoints import user, menu, spider, report, dashboard, chat, ai_engine, crawler
...
api_router.include_router(ai_engine.router, prefix="/ai-engines", tags=["AI引擎管理"])
